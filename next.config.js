...
const csp = [
  ...
  "img-src 'self' data: blob: https://images.unsplash.com https://*.unsplash.com https://*.cloudflare.com https://*.r2.cloudflarestorage.com https://*.googleusercontent.com https://*.googleapis.com https://*.gstatic.com https://*.ggpht.com https://*.airbnb.com https://*.muscache.com https://*.zillowstatic.com https://*.realtor.ca https://*.crea.ca https://*.cloudinary.com https://*.imgix.net https://q.stripe.com",
...
const nextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      { protocol: 'https', hostname: '*.muscache.com', port: '', pathname: '/**' },
      { protocol: 'https', hostname: '*.zillowstatic.com', port: '', pathname: '/**' },
      { protocol: 'https', hostname: '*.realtor.ca', port: '', pathname: '/**' },
      { protocol: 'https', hostname: '*.crea.ca', port: '', pathname: '/**' },
      { protocol: 'https', hostname: '*.cloudinary.com', port: '', pathname: '/**' },
      { protocol: 'https', hostname: '*.imgix.net', port: '', pathname: '/**' },
    ],
