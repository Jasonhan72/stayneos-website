  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "heading-1": ["clamp(1.5rem, 3vw, 2.25rem)", { lineHeight: "1.15", fontWeight: "600", letterSpacing: "-0.01em" }],
        "heading-2": ["clamp(1.25rem, 2.5vw, 1.75rem)", { lineHeight: "1.2", fontWeight: "600", letterSpacing: "-0.01em" }],
