    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-12">
          ...
          <div className="max-w-lg">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Welcome Back to<br />Your Home Away From Home
            </h1>
            <p className="text-lg text-white/90 leading-relaxed">
              Access your account and manage your luxury living experience
            </p>
          </div>
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center items-center p-6 sm:p-8 lg:p-16 bg-white">
        <div className="w-full max-w-md">
          ...
          {/* Server-rendered form structure with all inputs for SSR */}
          <form className="space-y-6" method="POST" action="/api/auth/login">
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
              Sign In
            </button>
