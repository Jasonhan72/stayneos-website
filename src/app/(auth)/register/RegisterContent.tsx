    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-[55%] xl:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-12 xl:p-16">
          <Link href="/" className="inline-block">
            <Image src="/logo-light.png" alt="NEOS" width={180} height={60} className="h-20 w-auto object-contain" priority={true} />
          </Link>
      ...
      <div className="w-full lg:w-[45%] xl:w-1/2 flex flex-col bg-white">
        <div className="lg:hidden p-6 border-b border-neutral-100">
          <Link href="/" className="inline-block"><Image src="/logo.png" alt="NEOS" width={140} height={48} className="h-14 w-auto object-contain" priority={true} /></Link>
        </div>
