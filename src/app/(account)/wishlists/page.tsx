...
type Property = { id: string; title: string; slug?: string; address?: string; city?: string; neighborhood?: string; priceMonthly?: number; basePrice?: number; currency?: string; bedrooms?: number; bathrooms?: number; reviewCount?: number; averageRating?: number; images?: { url: string; isPrimary?: boolean }[]; };
