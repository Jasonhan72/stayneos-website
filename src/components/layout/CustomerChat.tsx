...
export function CustomerChat() {
  ...
  const handleSendMessage = async (e: FormEvent) => {
    ...
    try {
      ...
      setError(t('chat.error', 'Sorry, there was an error sending your message. Please try again or email us at hello@neos.rentals.'));
      
      // Add fallback response
      const fallbackResponses = [
        t('chat.fallback.1', "For booking inquiries, please visit our properties page or use the AI concierge above."),
        t('chat.fallback.2', "For urgent matters, please email us at hello@neos.rentals."),
  ...
  return (
    <>
      ...
      <button
        ...
        className="chat-toggle-button fixed bottom-6 right-20 z-[1000] w-14 h-14 bg-[#2563eb] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-200"
      ...
      {isOpen && (
        <div
          ref={chatWindowRef}
          className="fixed bottom-24 right-6 z-[1001] w-[380px] h-[450px] bg-white rounded-lg shadow-2xl flex flex-col border border-gray-200"
          style={{
