...
export function RegisterForm() {
  ...
  // Removed handleSocialLogin - buttons are now disabled with "Coming Soon"
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-3">
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-lg border border-neutral-300 bg-white text-neutral-700 font-medium hover:bg-neutral-50 hover:border-neutral-400 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <button
          type="button"
          disabled={true}
          className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-lg bg-neutral-300 text-neutral-500 font-medium cursor-not-allowed opacity-75"
        >
