...
export function HeroChatInline() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      <form onSubmit={handleTopSubmit} className="relative group mx-auto max-w-3xl">
        ...
        <div className="relative hidden sm:flex items-center bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl overflow-hidden">
          <input
            ...
            className="min-w-0 flex-1 px-5 py-4 text-gray-800 placeholder-gray-400 bg-transparent outline-none text-base"
            disabled={isLoading}
          />
          <button
            type="submit"
